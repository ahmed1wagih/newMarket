...
<!-- DataTables -->
  <link rel="stylesheet" href="{{asset('AdminLTE/plugins/datatables/dataTables.bootstrap.css')}}">
   ...
   <!-- Content Header (Page header) -->
    ...
    <h1>التحكم فى إعدادات الفوتر</h1>
    </div>
  <div class="select-add">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/footersettings')}}"> التحكم فى الإعدادات </a></li>
     </ol>

     <div class="add_user" > 
      <a href="{{Url('admin/footersettings/create')}}" class="btn btn-primary add_user"> أضف إعداد جديد </a>
     </div>
        ...
        <table id="" class="table table-bordered table-striped">
          <thead>
            ...
            <tr>
              ...
              <th class="text-center">إسم الإعداد بالعربية</th>
              <th class="text-center">إسم الإعداد بالإنجليزية</th>
         ...
         <tbody>
          ...
          @foreach($settings as $setting)
            ...
            <td class="text-center">{{$setting->ar_name}}</td>
            <td class="text-center">{{$setting->en_name}}</td>
            ...
            <a href="{{url('admin/footersettings/'.$setting->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
            </td>
            <td class="text-center">
  
               {{Form::open(array('method'=>'delete','url'=>'admin/footersettings/'.$setting->id))}}

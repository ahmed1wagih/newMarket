         ...
         <div class="box">
          ...
          {!!Form::open(array(
           ...
           <div class="form-group @if($errors->has('ar_name')) has-error @endif">
              <div class="col-md-10">
                <input type="text" class="form-control" name="ar_name" value="{{old('ar_name')}}" placeholder="اسم الإعداد بالعربية">
           ...
           <div class="form-group @if($errors->has('en_name')) has-error @endif">
              <div class="col-md-10">
                <input type="text" class="form-control" name="en_name" value="{{old('en_name')}}" placeholder="اسم الإعداد بالإنجليزية">

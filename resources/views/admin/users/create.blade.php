        ...
        <div class="col-xs-12">
         <div class="box">
          ...
          <div class="form-group @if($errors->has('phone')) has-error @endif">
              <div class="col-md-10">
                <input type="text" class="form-control" name="phone" value="{{old('phone')}}"  placeholder="الهاتف">
           ...
           <div class="form-group @if($errors->has('address')) has-error @endif">
              <div class="col-md-10">
                <input type="text" class="form-control" name="address" value="{{old('address')}}"  placeholder="العنوان بالتفصيل">

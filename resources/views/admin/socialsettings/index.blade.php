...
<!-- DataTables -->
  <link rel="stylesheet" href="{{asset('AdminLTE/plugins/datatables/dataTables.bootstrap.css')}}">
   ...
   <!-- Content Header (Page header) -->
    ...
    <h1>التحكم فى إعدادات السوشيال ميديا</h1>
    </div>
  <div class="select-add">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/socialsettings')}}"> التحكم فى الإعدادات </a></li>
     </ol>

     <div class="add_user" > 
      <a href="{{Url('admin/socialsettings/create')}}" class="btn btn-primary add_user"> أضف إعداد جديد </a>
     </div>
        ...
        <table id="" class="table table-bordered table-striped">
         ...
         <tbody>
          ...
          @foreach($settings as $setting)
            ...
            <a href="{{url('admin/socialsettings/'.$setting->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
            </td>
            <td class="text-center">
  
               {{Form::open(array('method'=>'delete','url'=>'admin/socialsettings/'.$setting->id))}}
